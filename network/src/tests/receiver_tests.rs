...
use crate::central_accounting::CentralAccounting;
use crate::Receiver as NetworkReceiver;
use crate::Writer;
...
async fn receive() {
    ...
    NetworkReceiver::spawn(address, TestHandler { deliver: tx });
...
//     let address_1 = "127.0.0.1:4001".parse::<SocketAddr>().unwrap();
